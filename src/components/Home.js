...
function Home() {
  return (
    <div className="flex flex-grow justify-center items-center font-raleway m-5 mb-0 h-full w-screen bg-bgcolor">
    {/* info-card */}
      <div className="flex flex-col md:flex-row lg:inline-flex lg:flex-row 
        ...
        {/* card */}
        <div className='flex flex-col items-center justify-center text-center p-2 mt-5 lg:mt-0 mb-0'>
            {/* name */}
